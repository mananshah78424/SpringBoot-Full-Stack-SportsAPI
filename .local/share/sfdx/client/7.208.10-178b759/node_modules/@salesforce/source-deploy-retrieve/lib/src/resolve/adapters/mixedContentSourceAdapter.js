...
class MixedContentSourceAdapter extends baseSourceAdapter_1.BaseSourceAdapter {
    ...
    populate(trigger, component) {
        ...
        const contentPath = trimmedPath === component?.xml
            ? this.tree.find('content', (0, path_2.baseName)(trimmedPath), (0, path_1.dirname)(trimmedPath))
            : trimmedPath;
        ...
        if (component) {
            ...
            component = new sourceComponent_1.SourceComponent({
                ...
                type: this.type,
                content: contentPath,
                xml: this.type.metaFileSuffix && (0, path_1.join)(contentPath, this.type.metaFileSuffix),
