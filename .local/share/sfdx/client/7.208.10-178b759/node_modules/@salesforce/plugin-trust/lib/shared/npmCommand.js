...
class NpmCommand {
    static runNpmCmd(cmd, options = {}) {
        ...
        if (npmCmdResult.code !== 0) {
            throw new core_1.SfError(npmCmdResult.stderr, 'ShellExecError');
        }
        return npmCmdResult;
    }
    ...
    static findNode(root) {
        ...
        throw (0, errors_1.setErrorName)(new core_1.SfError('Cannot locate node executable.', 'CannotFindNodeExecutable'), 'CannotFindNodeExecutable');
    }
    /**
...
class NpmModule {
    ...
    show(registry) {
        ...
        if (showCmd.stdout === '') {
            throw (0, errors_1.setErrorName)(new core_1.SfError(`Failed to find ${this.module}@${this.version} in the registry`, 'NpmError'), 'NpmError');
        }
        try {
            ...
            if (error instanceof Error) {
                throw (0, errors_1.setErrorName)(new core_1.SfError(error.message, 'ShellParseError'), 'ShellParseError');
            }
            throw error;
        }
    }
    pack(registry, options) {
        try {
            ...
            if (err instanceof Error) {
                ...
                throw (0, errors_1.setErrorName)(e, 'NpmError');
            }
        }
        return;
    }
    ...
    async pollForAvailability(checkFn) {
        ...
        const ux = new sf_plugins_core_1.Ux({ jsonEnabled: isNonTTY });
